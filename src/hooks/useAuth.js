...
export function AuthProvider({ children }) {
  ...
  async function sendWhatsApp(phone, message) {
    ...
    if (!cfg.whatsapp_api_url) return
    try {
  ...
  // Retorna { otp } quando WhatsApp não configurado — para exibir na tela
  async function sendOTP(phone) {
    ...
    const cfg = await getSettings('salon_name','whatsapp_api_url')
