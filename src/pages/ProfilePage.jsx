    ...
    <div className="page">
      ...
      {(salonInfo.salon_name||salonInfo.salon_phone||salonInfo.salon_address) && (
        <div className="card" style={{marginTop:8}}>
          ...
          {salonInfo.salon_phone && (
            <p style={{fontSize:13,color:'var(--gray-500)',marginBottom:6,display:'flex',alignItems:'center',gap:6}}>
              <i className="ti ti-phone" aria-hidden="true" style={{fontSize:15}}/>
              {salonInfo.salon_phone}
            </p>
          )}
          {salonInfo.salon_address && (
            <p style={{fontSize:13,color:'var(--gray-500)',display:'flex',alignItems:'center',gap:6}}>
              <i className="ti ti-map-pin" aria-hidden="true" style={{fontSize:15}}/>
              {salonInfo.salon_address}
            </p>
          )}
        </div>
